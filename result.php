<?php 
    ...
    $sql = "SELECT * FROM `member_list` WHERE first_name LIKE '%$search%' || last_name LIKE '%$search%'";
    ...
    <div class="home">
        ...
        <nav>
          <ul class="navbar">
            ...
            <div class="relateUs">
            <li class="relatebut"><a href="#">Relate with Us</a></li>
        ...
        <div class="member-content">
            ...
            <?php if(isset($_SESSION['UserLogin'])){ ?>
                    ...
                    <?php } ?>
                <div class="numbers">
                    <p>we have <strong><?php echo $total ?></strong> member/s</p>
                </div>
                <div class="search">
